...
%define gobuild go build -buildmode pie -compiler gc -tags="rpm_crashtraceback ${GO_BUILDTAGS-${BUILDTAGS-}}"
%define gotest GO111MODULE=off go test -buildmode pie -compiler gc
